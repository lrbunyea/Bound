...
public class DialogueManager : MonoBehaviour {
    ...
    private void Start()
    {
        introductionDialogue = new string[] { "“Do not, under any circumstances, wear for more than eight hours a day.”",
        ...
        "Every day after lunch, I used to fly down this sidewalk and up those stairs to the track.",
